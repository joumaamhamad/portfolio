      ...
      <div className='flex items-center justify-center py-12'>
        <div className='flex flex-col items-center w-3/4 py-44 space-y-12'>
          ...
          <div className='md:flex md:flex-row md:items-center md:justify-center md:ml-0 md:space-x-24 md:py-12 flex-col items-center ml-8 w-full'>
            <div className='flex flex-col items-center justify-cente text-center space-y-2 border-white border-2 w-11/12 bg-gray-300 py-24 pr-16 pl-16 mt-12'>
            ...
            <div className='flex flex-col items-center justify-center text-center space-y-2 border-white border-2 w-11/12 bg-gray-300 py-24 pr-16 pl-16 mt-12'>
